    ...
    companion object {
        fun fillWebshopWithProducts(): List<MProduct> {
            val productOne = MProduct(
                ...
                price = 10,
                productImageURL = "https://i.postimg.cc/g0r4JwG0/blue-sneakers.jpg"
            )
            ...
            val productTwo = MProduct(
                ...
                price = 20,
                productImageURL = "https://i.postimg.cc/zfB5GkLR/designer-shoes.jpg"
            )
            ...
            val productThree = MProduct(
                ...
                price = 20,
                productImageURL = "https://i.postimg.cc/VLLKTZ2M/grey-boys-jeans.webp"
            )
            ...
            val productFour = MProduct(
                ...
                price = 20,
                productImageURL = "https://i.postimg.cc/66DdVjtt/la-cap.jpg"
            )
            ...
            val productFive = MProduct(
                ...
                price = 20,
                productImageURL = "https://i.postimg.cc/1t1Qr1CD/levis-bluejeans.jpg"
            )
            ...
            val productSix = MProduct(
                ...
                price = 20,
                productImageURL = "https://i.postimg.cc/qMh146MM/nike-cap.jpg"
            )
            ...
            val productSeven = MProduct(
                ...
                price = 20,
                productImageURL = "https://i.postimg.cc/RCnfXkSq/oakley-cap.jpg"
            )
            ...
            val productEight = MProduct(
                ...
                price = 20,
                productImageURL = "https://i.postimg.cc/XJ59tdkT/skinnyjeans-grey-liano.jpg"
            )
            ...
            val productNine = MProduct(
                ...
                price = 20,
                productImageURL = "https://i.postimg.cc/0ypR5B2Q/vans-shoes.jpg"
            )
            ...
            val productTen = MProduct(
                ...
                price = 20,
                productImageURL = "https://i.postimg.cc/WbY6FNzY/black-shirt.webp"
            )
            ...
            val productEleven = MProduct(
                ...
                price = 20,
                productImageURL = "https://i.postimg.cc/cJy3wrSh/yellowshirt.jpg"
            )
            ...
            val productTwelve = MProduct(
                ...
                price = 20,
                productImageURL = "https://i.postimg.cc/fLbR9NJ5/blue-shirt.jpg"
            )
